...
<form class="layui-form">
    <div class="login_face"><img src="/admin/images/face.png" class="userAvatar"></div>
...
<script type="text/javascript" src="/layui/modules/layer.js"></script>
<script type="text/javascript" src="/admin/js/login/login.js"></script>
